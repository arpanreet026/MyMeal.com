...
if (isset($_POST['action']) && isset($_POST['action']) == 'order') {
    ...
    $query = "INSERT INTO tbl_order (customer_name, customer_email, customer_contact, customer_address, pmode, food, total) VALUES ('$name', '$email', '$phone', '$address', '$pmode', '$products', '$grand_total')";
    ...
    $data .= '<div class="text-center">
                                <html>    <script src="https://kit.fontawesome.com/0a7af57943.js" crossorigin="anonymous"></script>
                                <br><i class="fa-solid fa-circle-check fa-10x" style="color: #22bf51;"></i></html>
