    ...
    <nav class="navbar navbar-expand-md bg-dark navbar-dark " style="color:white;">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar">
            <ul class="navbar-nav ml-auto" style="color:white;">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="./user.php"><i class="fa-solid fa-cart-plus mr-2"
                        ...
                        <tbody>
                            ...
                            while ($row = $result->fetch_assoc()):
                                ...
                                <tr>
                                    ...
                                    <td><img src="./images/<?= $row['product_image'] ?>" width="79" height="77"></td>
                                    <td>
                                        <?= $row['product_name'] ?>
                                    </td>
                                    <td>
                            ...
                            <tr>
                                <td colspan="3">
                                    <a href="./user.php" class="btn btn-success"><i
                                ...
                                <td>
                                    <a href="checkout.php" style="background-color:#f08b18; border:#f08b18;"
